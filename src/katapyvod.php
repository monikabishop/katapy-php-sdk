...
class KatapyVod {
	...
	static public function getRecentContentsFromLibrary($libraryCd) {
		$response = KatapyConnect::sendCommand("/contents/recent/library/" . $libraryCd, null);
		return json_decode($response);
	}

	static public function getPopularContentsFromLibrary($libraryCd) {
		$response = KatapyConnect::sendCommand("/contents/popular/library/" . $libraryCd, null);
		return json_decode($response);
	}
	
	static public function getRecentVideosFromLibrary($libraryCd) {
		$response = KatapyConnect::sendCommand("/contents/video/recent/library/" . $libraryCd, null);
		return json_decode($response);
	}

	static public function getPopularVideosFromLibrary($libraryCd) {
		$response = KatapyConnect::sendCommand("/contents/video/popular/library/" . $libraryCd, null);
		return json_decode($response);
	}
